...
== Changelog ==
= 1.7.5 =
- <strong>Corretti</strong> alcuni problemi di sicurezza del backend
= 1.7.4 =
- <strong>Aggiornamenti</strong> per rendere compatibile il plugin a PHP 8
= 1.7.3 =
- <strong>Aggiornamenti</strong> per compatibilità con la versione 5.9 di Wordpress
= 1.7.2 =
- <strong>Corretti</strong> alcuni bug minori e verificata compatibilità con versione Wordpress
= 1.7.1 =
- <strong>Corretto</strong> un bug che non permetteva di visualizzare correttamente i dati delle prenotazioni con lo shortcode [OccupazioneSpazio]
= 1.7.0 =
- <strong>Adeguamento</strong> alla versione 5.6 di Wordpress
= 1.6.6 =
