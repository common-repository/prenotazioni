...
#_PRENNOTE");
	...
	function update_Prenotazioni_settings(){
	    if(isset($_POST['origine']) And $_POST['origine'] == 'Salva_Opzioni_Prenotazioni'){	
			$Comunicazioni["OggettoAdmin"]=wp_strip_all_tags(filter_input(INPUT_POST,"oggetto_em_amm"));
			$Comunicazioni["MsgAdmin"]=sanitize_textarea_field(filter_input(INPUT_POST,"corpo_em_amm"));
			$Comunicazioni["OggettoUte"]=wp_strip_all_tags(filter_input(INPUT_POST,"oggetto_em_ute"));
			$Comunicazioni["MsgUte"]=sanitize_textarea_field(filter_input(INPUT_POST,"corpo_em_ute"));
