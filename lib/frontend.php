                           ...
                           '.$TitFinPren.'
                            ...
                            <div style="float:left;margin-left:5px;">
                                <div style="float:left;">
                                    ...
                                    <p>
                                            ...
                                            <input type="text" id="DataPrenotazione" name="DataPrenotazione"value="'.get_pre_Oggi().'">
                                    </p>
                                </div>
                            ...
                            <div style="float:left;margin-left:20px;">
                                ...
                                <p>					
                                    ...
                                    <input type="submit" class="navigazioneGiorni" value="Prenota" name="navigazioneGiorni" id="PrenotaFE"/>
                                </p>
                            </div>				
                        </fieldset>
                    </form>
